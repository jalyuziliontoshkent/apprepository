...
import { LayoutDashboard, PlusCircle, Package, MessageCircle } from 'lucide-react-native';
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="new-order"
        options={{
          tabBarIcon: ({ focused }) => <TabIcon Icon={PlusCircle} label="Buyurtma" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="orders"
