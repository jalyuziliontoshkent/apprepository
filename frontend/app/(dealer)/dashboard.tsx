    ...
    <SafeAreaView style={s.container}>
      ...
      >
        ...
        <View style={s.quickGrid}>
          <TouchableOpacity style={[s.quickCard, s.quickCardPrimary]} onPress={() => router.push('/(dealer)/new-order')}>
          ...
          <TouchableOpacity style={s.quickCard} onPress={() => router.push('/(dealer)/orders')}>
          ...
          <TouchableOpacity style={s.quickCard} onPress={() => router.push('/(dealer)/chat')}>
            <View style={s.quickIcon}>
        ...
        <SectionCard title="So`nggi buyurtmalar" subtitle="Oxirgi yuborilgan buyurtmalar">
          {error ? (
            ...
            <StateView title="Buyurtmalar hali yo`q" message="Birinchi buyurtmani yuboring, keyin statuslar shu yerda chiqadi." actionLabel="Buyurtma yaratish" onAction={() => router.push('/(dealer)/new-order')} />
          ) : (
